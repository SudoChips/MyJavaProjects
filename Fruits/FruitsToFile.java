...
public class FruitsToFile {
    public static void main(String[] args) throws IOException {
        ...
        oStr = String.format(fmtStr, Fruit1, price1, pounds1, price1 * pounds1);
        reportFile.print(oStr);
        oStr = String.format(fmtStr, Fruit2, price2, pounds2, price2 * pounds2);
        reportFile.print(oStr);
        oStr = String.format(fmtStr, Fruit3, price3, pounds3, price3 * pounds3);
        reportFile.print(oStr);
        oStr = String.format(fmtStr, Fruit4, price4, pounds4, price4 * pounds4);
        reportFile.print(oStr);
